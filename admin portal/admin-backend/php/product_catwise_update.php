<?php
 	if(isset($_POST['submit']))
 	{
		...
		$p_name = $_POST['p_name'];
 		...
 		if($conn->query($sql))
		{
			header("Refresh:0 ; url=product_show_catwise.php?id=$_GET[id]"); 
			$conn->close(); 
		}
		else
		{
...
<body>
	<div>
		<form class="form-group" id="pro_updateform" action="product_catwise_update.php?p_id=<?php echo$row['p_id']?>&id=<?php echo$row['c_id']?>" method="post">
